 ...
 * :xx - bind variable
 */
func (lexer *OracleLexer) ScanColon(child parser.ISQLLexer) *parser.Kind {
	lexer.ScanChar()
	return parser.SYMB_COLON
}
...
func init() {
	...
	KindMap["CONNECT"] = parser.CONNECT
	KindMap["CONNECT_BY_ROOT"] = parser.CONNECT_BY_ROOT
...
func (lexer *OracleLexer) GetKindMap() map[string]*parser.Kind {
	return KindMap
}